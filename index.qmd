...
::: {.yougov collapse="true" appearance="simple"}
### See original plot

<img src="assets/media/yougov_keir.png" style='border:1px solid #ff6756' >
:::
...
- A few things about axis scales:
    ...
    - We also use our `month_labels` function in `labels`. This works because `labels` can take any callable that recieves the axis breaks and then does whatever arbitrary thing you'd like to them, as long as it returns a label for plotting.
...
<img src="assets/media/yougov_bars.png" style='border:1px solid #ff6756' >
:::
...
<img src="assets/media/yougov_stacked.png" style='border:1px solid #ff6756' >
:::
